                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Provider.of<Helper>(context).text1("Payment Request", 20, FontWeight.w400, Colors.black, 'regular'),
                            Provider.of<Helper>(context).text1("View All", 20, FontWeight.w400, Colors.black, 'regular')
                          ],
                        ),
                        SizedBox(
                          height: 20,
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Provider.of<Helper>(context).text1("Payment History", 20, FontWeight.w400, Colors.black, 'regular'),
                            Provider.of<Helper>(context).text1("View All", 20, FontWeight.w400, Colors.black, 'regular')
                          ],
                        ),
                        Card(
            ...
            Positioned(
                ...
                child: Card(
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(20)),
                    elevation: 10,
                    child: Provider.of<Helper>(context).cont2(
                      color: Colors.white,
                      label: "available",
                    )))
          ],
